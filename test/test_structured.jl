...
function test_trace_asymptote(IsSingle=false)
   ...
   x1, y1 = trace(vx, vy, xstart, ystart, x, y; alg=RK4(), ds, gridType="meshgrid")
   x2, y2 = trace(vx, vy, xstart, ystart, x, y; alg=Euler(), ds, gridType="meshgrid")
...
function test_trace_dipole()
   ...
   x1, y1 = trace(bx, by, xstart, ystart, x, y; alg=RK4(), ds, gridType="meshgrid")
   x2, y2 = trace(bx, by, xstart, ystart, x, y; alg=Euler(), ds, gridType="meshgrid")
