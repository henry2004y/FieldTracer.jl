...
function test_trace_asymptote(issingle = false)
    ...
    ax1.plot(x4, y4, "g", label = "Euler ds=0.1", linewidth = 0.75)
    ax1.plot(x5, y5, "g--", label = "Euler ds=0.5", linewidth = 0.75)
    ax1.plot(x6, y6, "g:", label = "Euler ds=1.0", linewidth = 0.75)
...
function test_trace_dipole()
    ...
    for ystart in 0.0:5.0:31.0
        ...
        fig2.suptitle(
            "RK4 vs Euler's Method: Dipole Field for dS=" *
